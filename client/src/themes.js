/** Shiki themes available at runtime.
 *
 *  Shiki has no runtime theme registry and Vite cannot resolve a templated
 *  dynamic import against the package's exports map, so the table is explicit.
 *  Each entry is its own lazy chunk (~2.5 kB gzip); only the two in use are
 *  ever fetched.
 */
...
export const THEME_NAMES = Object.keys(THEME_LOADERS);

/** Split by overall brightness so each picker offers sensible choices. */
export const LIGHT_THEMES = ['ayu-light', 'catppuccin-latte', 'everforest-light', 'github-light', 'github-light-default', 'github-light-high-contrast', 'gruvbox-light-hard', 'gruvbox-light-medium', 'gruvbox-light-soft', 'horizon-bright', 'houston', 'kanagawa-lotus', 'light-plus', 'material-theme-lighter', 'min-light', 'night-owl-light', 'one-light', 'rose-pine-dawn', 'slack-ochin', 'snazzy-light', 'solarized-light', 'vitesse-light'];
export const DARK_THEMES = ['andromeeda', 'aurora-x', 'ayu-dark', 'ayu-mirage', 'catppuccin-frappe', 'catppuccin-macchiato', 'catppuccin-mocha', 'dark-plus', 'dracula', 'dracula-soft', 'everforest-dark', 'github-dark', 'github-dark-default', 'github-dark-dimmed', 'github-dark-high-contrast', 'gruvbox-dark-hard', 'gruvbox-dark-medium', 'gruvbox-dark-soft', 'horizon', 'kanagawa-dragon', 'kanagawa-wave', 'laserwave', 'material-theme', 'material-theme-darker', 'material-theme-ocean', 'material-theme-palenight', 'min-dark', 'monokai', 'night-owl', 'nord', 'one-dark-pro', 'plastic', 'poimandres', 'red', 'rose-pine', 'rose-pine-moon', 'slack-dark', 'solarized-dark', 'synthwave-84', 'tokyo-night', 'vesper', 'vitesse-black', 'vitesse-dark'];
